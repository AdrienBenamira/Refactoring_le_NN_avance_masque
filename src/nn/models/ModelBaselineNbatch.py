...
class ModelPaperBaselineN_batch(nn.Module):

    def __init__(self, args):
        super(ModelPaperBaselineN_batch, self).__init__()
        self.args = args
        self.word_size = args.word_size
        self.conv0 = nn.Conv2d(in_channels=len(self.args.inputs_type), out_channels=args.out_channel0, kernel_size=1)
