...
class ModelPaperBaseline_vbryan(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.conv2a = nn.Conv1d(32, 32, 3, stride=1, padding=1)
        self.bnconv1a = nn.BatchNorm1d(32)
        self.bnconv2a = nn.BatchNorm1d(32)
        self.conv1b = nn.Conv1d(32, 32, 3, stride=1, padding=1)
        self.conv2b = nn.Conv1d(32, 32, 3, stride=1, padding=1)
        self.bnconv1b = nn.BatchNorm1d(32)
        self.bnconv2b = nn.BatchNorm1d(32)
        self.conv1c = nn.Conv1d(32, 32, 3, stride=1, padding=1)
        self.conv2c = nn.Conv1d(32, 32, 3, stride=1, padding=1)
        self.bnconv1c = nn.BatchNorm1d(32)
        self.bnconv2c = nn.BatchNorm1d(32)

        self.conv3a = nn.Conv1d(32, 64, 3, stride=1, padding=1)
        self.conv4a = nn.Conv1d(64, 64, 3, stride=1, padding=1)
        self.bnconv3a = nn.BatchNorm1d(64)
        self.bnconv4a = nn.BatchNorm1d(64)
        self.conv3b = nn.Conv1d(64, 64, 3, stride=1, padding=1)
        self.conv4b = nn.Conv1d(64, 64, 3, stride=1, padding=1)
        self.bnconv3b = nn.BatchNorm1d(64)
        self.bnconv4b = nn.BatchNorm1d(64)
        self.conv3c = nn.Conv1d(64, 64, 3, stride=1, padding=1)
        self.conv4c = nn.Conv1d(64, 64, 3, stride=1, padding=1)
        self.bnconv3c = nn.BatchNorm1d(64)
        self.bnconv4c = nn.BatchNorm1d(64)

        self.conv5a = nn.Conv1d(64, 128, 3, stride=1, padding=1)
        self.conv6a = nn.Conv1d(128, 128, 3, stride=1, padding=1)
        self.bnconv5a = nn.BatchNorm1d(128)
        self.bnconv6a = nn.BatchNorm1d(128)
        self.conv5b = nn.Conv1d(128, 128, 3, stride=1, padding=1)
        self.conv6b = nn.Conv1d(128, 128, 3, stride=1, padding=1)
        self.bnconv5b = nn.BatchNorm1d(128)
        self.bnconv6b = nn.BatchNorm1d(128)
        self.conv5c = nn.Conv1d(128, 128, 3, stride=1, padding=1)
        self.conv6c = nn.Conv1d(128, 128, 3, stride=1, padding=1)
        self.bnconv5c = nn.BatchNorm1d(128)
        self.bnconv6c = nn.BatchNorm1d(128)
