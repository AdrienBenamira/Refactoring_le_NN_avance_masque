...
class NN_Model_Ref_8class:
    ...
    def choose_model(self):
        ...
        return ModelPaperBaseline_8class(self.args).to(self.device)


    def create_data(self):
        if self.args.make_data_equilibre_8class:
            self.X_train_nn_binaire, self.Y_train_nn_binaire, self.c0l_train_nn, self.c0r_train_nn, self.c1l_train_nn, self.c1r_train_nn = self.creator_data_binary.make_train_data_general_8class(self.args.nbre_sample_train);
            self.X_val_nn_binaire, self.Y_val_nn_binaire, self.c0l_val_nn, self.c0r_val_nn, self.c1l_val_nn, self.c1r_val_nn = self.creator_data_binary.make_train_data_general_8class(
